...
//    dotView.layer.cornerRadius = sizeDot / 2.;
    ...
    moneyLabel.frame = CGRectMake(0, 0, 40, 21);
    moneyLabel.center = CGPointMake(self.frame.size.width / 2., (self.frame.size.height / 2.) +sizeDot * 2.5);
    moneyLabel.layer.cornerRadius = sizeDot / 2.;
}
